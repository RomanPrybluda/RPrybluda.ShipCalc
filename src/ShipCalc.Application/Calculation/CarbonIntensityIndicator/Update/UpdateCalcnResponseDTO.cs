...
public class UpdateCalcnResponseDTO
{
    ...
    public decimal RefLineReductionFactor { get; set; }
    ...
    public static UpdateCalcnResponseDTO FromCalculation(CarbonIntensityIndicatorCalculation calculation, Ship? ship)
    {
        return new UpdateCalcnResponseDTO
        {
            Id = calculation.Id,
